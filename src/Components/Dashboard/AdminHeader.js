...
// ── Admin data (swap with props/context in real app) ──
const admin = {
  name:  "Administrator",
  id:    "ADM-20250001",
  role:  "School Admin",
        ...
        <div style={{ position: "relative" }} ref={dropRef}>
          <button onClick={() => setDropOpen(o => !o)} style={{
            ...
            <div style={{ textAlign: "left", lineHeight: 1 }}>
              <p style={{ margin: 0, fontSize: "14px", fontWeight: "600", color: "#1a1a1a" }}>{admin.name}</p>
              <p style={{ margin: "3px 0 0", fontSize: "12px", color: "#888", fontWeight: "400" }}>{admin.role}</p>
            </div>
          ...
          {dropOpen && (
            <div style={{
              ...
              <div style={{ padding: "18px 20px", background: "linear-gradient(135deg,#f4faf5,#eaf5ec)", borderBottom: "1px solid #e8f0e9", display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  <p style={{ margin: 0, fontWeight: "700", color: "#1a1a1a", fontSize: "15px" }}>{admin.name}</p>
                  <p style={{ margin: "3px 0 0", fontSize: "12px", color: "#5a9a68", fontWeight: "500" }}>{admin.role}</p>
                </div>
              </div>
              ...
              <div style={{ padding: "14px 20px", borderBottom: "1px solid #f5f5f5", display: "flex", alignItems: "center", gap: "12px" }}>
                ...
                <div>
                  <p style={{ margin: 0, fontSize: "11px", color: "#aaa", textTransform: "uppercase", letterSpacing: "0.06em" }}>Admin ID</p>
                  <p style={{ margin: "4px 0 0", fontSize: "13px", fontWeight: "600", color: "#333", fontFamily: "monospace" }}>{admin.id}</p>
                </div>
              </div>
